    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('data-capaian.update', $capaians->id)); ?>" method="POST">
                            ...
                            <select name="dosen_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"
                                        <?php echo e($data->id == $capaians->dosen_id ? 'selected' : ''); ?>><?php echo e($data->user->nama); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="judul_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $juduls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"
                                        <?php echo e($data->id == $capaians->judul_id ? 'selected' : ''); ?>><?php echo e($data->nama_judul); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul_capaian" class="form-control"
                                placeholder="Masukan judul capaian" value="<?php echo e($capaians->judul_capaian ?? '-'); ?>">
                        </div>
                        <div class="mb-3">
                            <label>Isi Capaian</label>
                            <input type="text" name="isi_capaian" class="form-control" placeholder="Masukan isi capaian"
                                value="<?php echo e($capaians->isi_capaian ?? '-'); ?>">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Alim Rahmat\Aplikasi Program\XAMPP\htdocs\TA\taalimfl\resources\views/rps/capaian/edit.blade.php ENDPATH**/ ?>