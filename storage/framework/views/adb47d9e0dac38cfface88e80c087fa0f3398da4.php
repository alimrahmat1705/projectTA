    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('data-metode.update', $metodes->id)); ?>" method="POST">
                            ...
                            <select name="dosen_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"
                                        <?php echo e($data->id == $metodes->dosen_id ? 'selected' : ''); ?>><?php echo e($data->nama); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="target_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $targets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"
                                        <?php echo e($data->id == $metodes->target_id ? 'selected' : ''); ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="bentuk_metode" class="form-control"
                                placeholder="Masukan nama bentuk metode" value="<?php echo e($metodes->bentuk_metode); ?>">
                        </div>
                        <div class="mb-3">
                            <label>Kondisi Metode</label>
                            <input type="text" name="kondisi_metode" class="form-control"
                                placeholder="Masukan nama kondisi metode" value="<?php echo e($metodes->kondisi_metode); ?>">
                        </div>
                        <div class="mb-3">
                            <label>Pengalaman Metode</label>
                            <input type="text" name="pengalaman_metode" class="form-control"
                                placeholder="Masukan nama pengalaman metode" value="<?php echo e($metodes->pengalaman_metode); ?>">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taalimfl\resources\views/rps/metode/edit.blade.php ENDPATH**/ ?>