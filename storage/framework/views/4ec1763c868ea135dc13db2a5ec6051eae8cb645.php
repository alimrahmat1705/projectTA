...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('kode_mk',$mata_kuliahs->kode_mk)); ?>" name="kode_mk" required >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('matkul',$mata_kuliahs->matkul)); ?>" name="matkul" required >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('prodi',$mata_kuliahs->prodi)); ?>" name="prodi" required >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('semester',$mata_kuliahs->semester)); ?>" name="semester" required >
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sks',$mata_kuliahs->sks)); ?>" name="sks" required >
                        <?php $__errorArgs = ['sks'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Alim Rahmat\Aplikasi Program\XAMPP\htdocs\taalimfl\resources\views/matakuliah/edit.blade.php ENDPATH**/ ?>