                ...
                <li class="nav-item">
                    ...
                    <div id="collapseRps" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('data-subjudul.index')); ?>">Subjudul</a>
                            <a class="collapse-item" href="<?php echo e(route('data-konten.index')); ?>">Konten</a>
                            <a class="collapse-item" href="<?php echo e(route('data-capaian.index')); ?>">Capaian (CPMK)</a>
                            <a class="collapse-item" href="<?php echo e(route('data-target.index')); ?>">Target Pencapaian</a>
                            <a class="collapse-item" href="<?php echo e(route('data-kajian.index')); ?>">Kajian Pencapaian</a>
                            <a class="collapse-item" href="<?php echo e(route('data-metode.index')); ?>">Metode Pencapaian</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
        ...
        <!-- End of Sidebar -->
<?php /**PATH C:\xampp\htdocs\taalimfl\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>