...
<body>
    ...
    <table class="table-body">
        ...
        <tr>
            <td colspan="2">
                <p style="text-align: center; margin-top: 60px; margin-bottom: 10px"><?php echo e($cetaks->user->nama  ?? '-'); ?></p>
            </td>
            <td colspan="2" style="height: 70px">
                <p style="text-align: center; margin-top: 60px; margin-bottom: 10px"><?php echo e($cetaks->jurusan->nama_kajur  ?? '-'); ?></p>
            </td>
            <td colspan="2" style="height: 70px">
                <p style="text-align: center; margin-top: 60px; margin-bottom: 10px"><?php echo e($cetaks->prodi->nama_kaprodi  ?? '-'); ?></p>
            </td>
        </tr>
...
<?php /**PATH D:\Alim Rahmat\Aplikasi Program\XAMPP\htdocs\Final Final TA\taalimfl\resources\views/rps/cetak-rps/cetak-rps.blade.php ENDPATH**/ ?>