...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nama')); ?>" name="nama" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nip')); ?>" name="nip" required>
                                <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('jenis_kelamin')); ?>" name="jenis_kelamin" required>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taalimfl\resources\views/dosen/create.blade.php ENDPATH**/ ?>