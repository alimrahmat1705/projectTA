...
<body id="page-top">
    ...
    bobot_uas: $("#bobot_uas").val(),
        ...
        $('#mahasiswa_nama').change(function() {
            ...
            $.ajax({
                ...
                for (key in data) {
                    ...
                    kompeten.append('<option id=' + data[key] + ' value=' + data[key] + '>' + data[key] + '</option>');
                }
                var sikap = $('#sikap');

                for (key in data) {
                    console.log(data[key]);
                    sikap.append('<option id=' + data[key] + ' value=' + data[key] + '>' + data[key] + '</option>');
                }
                var tugas = $('#tugas');

                for (key in data) {
                    console.log(data[key]);
                    tugas.append('<option id=' + data[key] + ' value=' + data[key] + '>' + data[key] + '</option>');
                }
                var nilai_akhir = $('#nilai_akhir');

                for (key in data) {
                    console.log(data[key]);
                    nilai_akhir.append('<option id=' + data[key] + ' value=' + data[key] + '>' + data[key] + '</option>');
                }
...
<?php /**PATH D:\Alim Rahmat\Aplikasi Program\XAMPP\htdocs\taalim\resources\views/layouts/main.blade.php ENDPATH**/ ?>