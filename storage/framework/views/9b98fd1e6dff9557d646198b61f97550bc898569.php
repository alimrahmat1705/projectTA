    ...
    <a href="<?php echo e(route('cetaknilaiakhirpreview')); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-eye"></i> Pratinjau PDF</a>
    <a href="<?php echo e(route('cetaknilaiakhir')); ?>" class="btn btn-primary" target="_blank">CETAK PDF</a>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mahasiswa_id')); ?>" name="mahasiswa_id" id="mahasiswa_nama" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mata_kuliah_id')); ?>" name="mata_kuliah_id" id="mata_kuliah_id" required>
                                                                <option value="" disabled selected>Nama</option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('kompetensi')); ?>" name="kompetensi" id="kompeten" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sikap')); ?>" name="sikap" id="sikap" required>
                                                                <option value="" disabled selected>Nilai</option>
                                                            </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tugas')); ?>" name="tugas" id="tugas" required>
                                                                <option value="" disabled selected>Nilai</option>
                                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <input type="number"  class="form-control  <?php $__errorArgs = ['nilaiakhir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nilaiakhir')); ?>" name="nilaiakhir" id="nilaiakhir" >
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Alim Rahmat\Aplikasi Program\XAMPP\htdocs\taalimfl\resources\views/nilaiakhir.blade.php ENDPATH**/ ?>