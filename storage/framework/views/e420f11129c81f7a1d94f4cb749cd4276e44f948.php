    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" action ="/dosen/<?php echo e($dosens->id); ?>" method="post">
                                    ...
                                    <select name="jurusan_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $jurusans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->id); ?>"
                                                <?php echo e($data->id == $dosens->jurusan_id ? 'selected' : ''); ?>>
                                ...
                                <div class="mb-e">
                                    ...
                                    <select name="prodi_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->id); ?>"
                                                <?php echo e($data->id == $dosens->prodi->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nama', $dosens->nama)); ?>" name="nama" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nip', $dosens->nip)); ?>" name="nip" required>
                                <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('jenis_kelamin', $dosens->jenis_kelamin)); ?>" name="jenis_kelamin"
                                    required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('tanggal_lahir', $dosens->tanggal_lahir)); ?>" name="tanggal_lahir"
                                    required>
...
unset($__errorArgs, $__bag); ?>" name="alamat" required><?php echo e(old('alamat', $dosens->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nomor_telepon', $dosens->nomor_telepon)); ?>" name="nomor_telepon"
                                    required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('email', $dosens->email)); ?>" name="email" required>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taalimfl\resources\views/dosen/edit.blade.php ENDPATH**/ ?>