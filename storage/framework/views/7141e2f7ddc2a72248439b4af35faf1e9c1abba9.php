    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('data-konten.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label>Dosen</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="subjudul_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $subjuduls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"><?php echo e($data->nama_subjudul); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taalimfl\resources\views/rps/kontent/create.blade.php ENDPATH**/ ?>